...
namespace dqn {
  ...
  class RouterCTCE {
    ...
    public:
          ...
          vector<int> faces_id;
          vector<int> provis_faces_id;
          vector<int> faces_id_without_input;
          RouterCTCE();
          ~RouterCTCE();
          ...
          void start_sock(std::vector<int>& faces_id,int seed,int sim_time,bool* agent_started, int NodeID) ;
          ...
          //main methods --------------------------------
          void Send_State(std::vector<float>& State,int inFaceIndex ,std::vector<int>& faces_id ,int seed,int sim_time,bool* agent_started, int NodeID) ;
          int get_Best_Face_id();
          void Send_reward(std::vector<float>& State,int chosen_face,float reward, int NodeID, std::vector<float>& next_State);
