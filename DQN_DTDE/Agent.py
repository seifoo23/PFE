...
def dqn(seed,myScenario,_clientsocket, _ip, _port, _server_port, max_buffer_size=4096, timeout=40):
    
    simulation_number = seed
    log_file_path = f'/home/bedreddine/Desktop/my-simulations/logs/{myScenario}/DQN/log_{simulation_number}.txt'    
    ...
    try:
          _clientsocket.settimeout(timeout)  # Set socket timeout 
                ...
                try:
                    ...
                    if data.strip():
                            ...
                            if (received_json["Type"] == "Init"):
                                ...
                                function = received_json["function"]
                                ...
                                print(f'[Agent {agent.process_id}]Received reward message : State={State}, chosen_face={chosen_face}, reward={reward}, function={function}')
                                ...
                                try:
                                    ...
                                    logging.error(f"Error processing reward message in function {function}: {e}")
                                    traceback.print_exc()
                    ...
                    print(f'[python-side / instance_id: {_server_port}] No data received for {timeout} seconds. Terminating...')
                    break    
